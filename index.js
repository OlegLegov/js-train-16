...
function logArrayElements(arr) {
  ...
  arr.forEach(function (element, index) {
    // Виводимо в консоль поточний елемент масиву та його індекс
...
function displayGroupedInfo(students) {
  ...
  // Перебираємо масив об'єктів-студентів
  for (let student of students) {
    // Створюємо групу з повідомленням "Студент: {ім'я студента}"
...
function validateUserInput(userInput) {
  ...
  // Перевіряємо, чи в об'єкті є ім'я користувача
  console.assert(
    userInput.hasOwnProperty("username"),
    "Помилка: ім'я користувача відсутнє!"
  );

  // Перевіряємо, чи в об'єкті є пароль
  console.assert(
...
function countVowelsAndConsonants(word) {
  ...
  // Створюємо рядок, де будуть всі голосні
  let vowels = "aeiou";

  // Лічильник голосних і приголосних
  let vowelCount = 0;
  ...
  for (let letter of word) {
    ...
    // Перевіряємо, чи є літера у нашому рядку з голосними
    if (vowels.includes(lowercaseLetter)) {
      ...
      consonantCount++; // Інакше, якщо літера знаходиться у межах a-z, збільшуємо лічильник приголосних
    }
  }
